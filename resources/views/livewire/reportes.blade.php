                        ...
                        <div class="col-12">
                            <div class="card mb-4 mx-4">
                                <div class="card-header pb-0">
                                    <div>
                                        <h2 class="mb-0">Registros Holter</h2>
                                    </div>
                                    <div class="d-flex flex-row justify-content-between">
                                        @foreach($pcte as $pc)
                                        <div class="col-md-6">
                                            <p class="mb-1"><strong>Paciente:</strong> {{$pc->identificacion}} - {{$pc->nombres}} {{$pc->apellidos}}</p>
                                            <p class="mb-1"><strong>Edad:</strong> {{$edad}} años</p>
                                            <p class="mb-1"><strong>Celular:</strong> {{$pc->celular}}</p>
                                            <?php
                                            $class = ($pc->genero === 'Femenino') ? 'fas fa-venus' : 'fas fa-mars';
                                            ?>
                                            <p class="mb-1"><strong>Sexo: </strong><i class="<?php echo $class; ?>" title="<?php echo $pc->genero; ?>"></i></p>
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <span>
                                                            <i class="cursor-pointer fas fa-chart-line text-danger"
                                                                wire:click="graficar({{$procedimiento->id}})" onclick="loadGrafico()"
                                                                data-bs-original-title="Ver Reporte"></i>
                                                        </span>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">El usuario NO tiene registros Holsters en estado cerrado</p>
                                                    </td>
                                                </tr>
                                                @endif
                                            </tbody>
