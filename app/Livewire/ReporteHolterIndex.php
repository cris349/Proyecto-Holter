...
class ReporteHolterIndex extends Component
{
    ...
    public function render()
    {
        ...
        $listadoProcedimientos = Procedimientos::with(['paciente', 'dispositivo'])
            ...
            ->where(['procedimientos.estado_proc' => 'CERRADO'])
            ->orderBy('id')
            ->get();

        return view('livewire.reportes', compact('data', 'registros', 'listadoProcedimientos', 'pcte', 'edad'));
    }
